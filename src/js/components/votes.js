...
import titleHTML from '../text/title.html!text'
import imgHTML from '../text/img.html!text'
import textHTML from '../text/text.html!text'
import ballotHTML from '../text/ballot.html!text'
...
function app(el, config, data) {
    ...
    el.innerHTML = '<div class="mayor-container">' +
...
export default function init(el, config) {
    fetch(`https://interactive.guim.co.uk/docsdata/${sheetId}.json`).then(data => app(el, config, data));
}
